                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-stone-50 dark:bg-stone-900/40 p-3 rounded-lg border border-rose-100/40 dark:border-stone-800 space-y-2 text-[11px] font-sans">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-stone-500 dark:text-stone-400">
                      <li>Go to your <a href="https://console.firebase.google.com/project/mutu-forcouple/authentication/providers" target="_blank" rel="noopener noreferrer" className="underline font-bold text-rose-500 hover:text-rose-600">Firebase Auth Console</a>.</li>
